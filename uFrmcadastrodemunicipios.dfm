inherited FuFrmcadastrodemunicipios: TFuFrmcadastrodemunicipios
    ...
    inherited pgc1: TPageControl
        ...
        object dbgrd1: TDBGrid
          ...
          Columns = <
            ...
            item
              ...
              Title.Caption = 'C'#243'digo Geral'
              Visible = True
            end
            item
              Expanded = False
      ...
      inherited ts2: TTabSheet
        ...
        object btndbe1: TxDbButtonEdit
          ...
          AltBtnWidth = 15
          ButtonWidth = 15
          OnButtonClick = btndbe1ButtonClick
          EnterPressF8 = False
  ...
  object cdsmunicipio: TClientDataSet
    ...
    Left = 600
    Top = 120
    object coluncdsmunicipioid: TIntegerField
      FieldName = 'id'
    end
    object coluncdsmunicipiosigla: TWideStringField
      FieldName = 'sigla'
      Size = 200
    end
    object coluncdsmunicipionome: TWideStringField
      FieldName = 'nome'
      Size = 200
    end
    ...
    object colun_ibge: TIntegerField
      FieldName = 'codigo_ibge'
    end
  end
  object pdbplnmunicipio: TppDBPipeline
    DataSource = dsmunicipio
    UserName = 'pdbplnmunicipio'
    Left = 600
    Top = 240
  end
  object Relatoriomunicipio: TppReport
    AutoStop = False
    DataPipeline = pdbplnmunicipio
    ...
    Version = '15.03'
    mmColumnWidth = 0
    DataPipelineName = 'pdbplnmunicipio'
    object phdrbnd1: TppHeaderBand
      ...
      object plbl7: TppLabel
        UserName = 'plbl7'
        Caption = 'Relat'#243'rio de Munic'#237'pio Cadastrados'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 16
    ...
    object psmrybnd1: TppSummaryBand
      ...
      object plbl12: TppLabel
        UserName = 'plbl12'
        Caption = 'Total de Munic'#237'pios:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
