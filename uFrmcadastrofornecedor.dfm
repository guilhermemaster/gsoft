inherited TFurmcadastrofornecedor: TTFurmcadastrofornecedor
    ...
    inherited pgc1: TPageControl
      ...
      inherited ts1: TTabSheet
        ...
        inherited cbb1: TComboBoxEx
          ItemsEx = <
            item
              Caption = 'C'#211'DIGO DO FORNECEDOR'
            end
            item
              Caption = 'NOME'
            end
      ...
      inherited ts2: TTabSheet
        ...
        object edtendereco: TDBEdit
          ...
          Width = 274
          Height = 21
          Hint = 'Endere'#231'o do Fornecedor'
        ...
        object mmoobser: TRzDBMemo
          ...
          Width = 670
          Height = 89
          Hint = 'Observa'#231#227'o sobre o fornecedor'
          DataField = 'obser'
          DataSource = dsfornecedor
          ParentShowHint = False
          ShowHint = True
        ...
        object edtcidade: TxDbButtonEdit
          ...
          Width = 121
          Height = 21
          Hint = 'Munic'#237'pio do fornecedor'
          DataSource = dsfornecedor
          DataField = 'cidade'
          Color = clWhite
          FocusColor = 13431548
          ...
          AltBtnWidth = 15
          ButtonWidth = 15
          OnButtonClick = edtcidadeButtonClick
          EnterPressF8 = False
  ...
  object cdsfornecedor: TClientDataSet
    ...
    Left = 624
    Top = 64
    object coluncdsfornecedoridfornecedor: TIntegerField
      FieldName = 'idfornecedor'
    end
    object coluncdsfornecedornome: TWideStringField
      FieldName = 'nome'
      Size = 150
    end
    object coluncdsfornecedorcep: TWideStringField
      FieldName = 'cep'
      EditMask = '00000\-9999;1;_'
      Size = 100
    end
    object coluncdsfornecedorendereco: TWideStringField
      FieldName = 'endereco'
      Size = 150
    end
    object coluncdsfornecedorcidade: TWideStringField
      FieldName = 'cidade'
      Size = 200
    end
    object coluncdsfornecedoruf: TWideStringField
      FieldName = 'uf'
      Size = 150
    end
    object coluncdsfornecedorcomissao: TFloatField
      FieldName = 'comissao'
    end
    object coluncdsfornecedorcnpj: TWideStringField
      FieldName = 'cnpj'
    end
    ...
    object coluncdsfornecedoremail: TWideStringField
      FieldName = 'email'
      Size = 150
    end
    ...
    object coluncdsfornecedorobser: TWideStringField
      FieldName = 'obser'
      Size = 300
    end
  end
  ...
  object pdbplnfornecedor: TppDBPipeline
    DataSource = dsfornecedor
    UserName = 'pdbplnfornecedor'
    Left = 624
    Top = 184
    ...
    object pfldField12: TppField
      FieldAlias = 'telefone_2'
      FieldName = 'telefone_2'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object pfldField14: TppField
      FieldAlias = 'status_fornecedor'
      FieldName = 'status_fornecedor'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
  ...
  object Relatoriofornecedor: TppReport
    AutoStop = False
    DataPipeline = pdbplnfornecedor
    ...
    Version = '15.03'
    mmColumnWidth = 0
    DataPipelineName = 'pdbplnfornecedor'
    ...
    object pdtlbnd1: TppDetailBand
      ...
      mmHeight = 10054
      mmPrintPosition = 0
      object pdbtxtidfornecedor: TppDBText
        UserName = 'pdbtxtidfornecedor'
